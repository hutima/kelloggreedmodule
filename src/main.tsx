...
import { installGlobalErrorLog } from './ui/errorLog';
import './ui/styles/global.css';

// Capture JS errors to an on-device log BEFORE anything else runs, so a crash
// during startup or a gesture survives the reload and is shown by the
// DiagnosticsBanner — the only way to read errors on a phone with no console.
