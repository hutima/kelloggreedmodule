...
const ROLE_TO_FAMILY: Partial<Record<SyntacticRole, keyof typeof REL_FAMILY>> = {
  ...
  agent: 'complement',
  objectLikeComplement: 'object',
  retainedAccusative: 'object',
  accusativeModifier: 'modifier',
  accusativeExtent: 'modifier',
  accusativeRespect: 'modifier',
  substantivalPrepositionalPhrase: 'prepositional',
  adjectival: 'modifier',
  adverbial: 'modifier',
  determiner: 'modifier',
  genitive: 'modifier',
