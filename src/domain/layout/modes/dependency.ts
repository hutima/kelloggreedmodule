...
export const SHORT_ROLE: Partial<Record<SyntacticRole, string>> = {
  ...
  agent: 'agent',
  objectLikeComplement: 'obj-like',
  accusativeModifier: 'acc-mod',
  accusativeExtent: 'acc-ext',
  accusativeRespect: 'acc-resp',
  retainedAccusative: 'ret-acc',
  substantivalPrepositionalPhrase: 'subst-pp',
  adjectival: 'adj',
  adverbial: 'adv',
  determiner: 'det',
  genitive: 'gen',
