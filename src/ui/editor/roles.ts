...
export const ROLE_LABEL: Record<SyntacticRole, string> = {
  ...
  agent: 'agent',
  objectLikeComplement: 'object-like complement',
  accusativeModifier: 'accusative modifier',
  accusativeExtent: 'accusative of extent',
  accusativeRespect: 'accusative of respect',
  retainedAccusative: 'retained accusative',
  substantivalPrepositionalPhrase: 'substantival prep. phrase',
...
export const ROLE_DESC: Partial<Record<SyntacticRole, string>> = {
  ...
  objectLikeComplement: 'Functions like the thing acted on, without claiming an ordinary direct object.',
  accusativeModifier: 'An accusative whose exact function (extent, respect, retained…) is left open.',
  accusativeExtent: 'Adverbial accusative of extent — “to what degree / how far”.',
  accusativeRespect: 'Accusative of respect or reference — “with respect to…”.',
  retainedAccusative: 'An accusative kept with a passive verb (only when the source marks it).',
  substantivalPrepositionalPhrase: 'An article + prepositional phrase functioning as a noun (“the things…”).',
